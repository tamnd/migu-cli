...
Most of these come down to network reality or how migu serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

migu rate-limits like any public site. migu already paces
...
Where a surface is gated, migu reads a cookie or token you supply
...
`migu`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what migu actually did
